...
class ROCMetric(object):
    ...
    def update(self, pred, label):
        ...
        self.background_area = self.background_area + int(tmp_back_area)
    ...
    def get(self):
        ...
        #return fpr, tpr, integrate.trapz(x=fpr, y=tpr)
        return fpr, tpr, integrate.trapz(x=np.flip(np.append(fpr, 0)), y=np.flip(np.append(tpr, 0)))
